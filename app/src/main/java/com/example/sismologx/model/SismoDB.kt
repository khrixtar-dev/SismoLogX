...
// Null es lo que devulve si no tira nada
class SismoDB (context: Context) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION) {
    ...
    // Limpiar
    fun clear() {
        writableDatabase.delete(TABLE_SISMOS, null, null)
    }
    ...
    companion object {
        ...
        const val COL_MAGNITUDE = "magnitude"
        const val COL_DEPTH = "depth"
...
// Es la misma DataClass que sismo , pero esta para DB
